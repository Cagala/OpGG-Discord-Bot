...
from ..getNextID import Get_NEXTID
from .opChampBuilds import opChampBuilds

class opGGChamps(View):
        def __init__(self, ctx, bot, champName, position) -> None:
        ...
        async def setup(self):
            ...
            await self.ctx.edit(content=self.ctx.author.mention, embed=self.Embeds[self.current_page], view=self)